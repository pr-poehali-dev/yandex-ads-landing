...
const advantages = [
  ...
  {
    icon: "Hand",
    title: "Пощупай перед покупкой",
    desc: "В отличие от маркетплейсов — у нас можно примерить, потрогать и проверить товар до оплаты. Никакого кота в мешке.",
  },
  {
    icon: "RotateCcw",
    title: "Возврат за 2 недели",
    desc: "Новый товар можно вернуть в течение 14 дней без объяснения причин. Быстро и без бюрократии.",
  },
];
