...
const advantages = [
  ...
  },
  {
    ...
    desc: "Более 3000 товаров: велосипеды, тренажёры, одежда, обувь и аксессуары.",
  },
];
      ...
      <section className="relative min-h-screen flex flex-col justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 py-24">
          ...
          >
            ...
            Более 3000 товаров. Доставка по Керчи и всему Крыму.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg leading-relaxed mb-8" style={{ color: "rgba(255,255,255,0.6)" }}>
                «Адреналин» — крупнейший спортивный магазин в Керчи. Работаем с 2010 года
                и за это время помогли тысячам спортсменов найти идеальное снаряжение.
              </p>
              <div className="flex flex-wrap gap-8">
                {[
                  { num: "15+", label: "лет на рынке" },
                  { num: "3000+", label: "товаров в наличии" },
